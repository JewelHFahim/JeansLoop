...
export default function NewProductPage() {
    ...
    const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            // Backend returns { image: "url" }, frontend was expecting { url: "url" }
        ...
        <div className="space-y-6 max-w-5xl mx-auto pb-20">
            ...
            <div className="flex items-center justify-between border-b-4 border-black pb-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-black tracking-tighter uppercase italic leading-none">Execute / New Product</h1>
                        <p className="text-[10px] font-black text-black uppercase tracking-[0.2em] mt-1">Inventory Initialization Sequence</p>
                    </div>
                </div>
                <Button
