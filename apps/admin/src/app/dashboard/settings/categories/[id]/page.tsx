...
import { ChevronLeft, Save, Upload, X, FolderSync } from 'lucide-react';
...
export default function EditCategoryPage() {
    ...
    const { data: category, isLoading: isFetching } = useQuery({
        ...
        queryFn: async () => {
            const response = await categoriesApi.getById(id as string);
    ...
    const updateMutation = useMutation({
        mutationFn: (data: any) => categoriesApi.update(id as string, data),
        onSuccess: () => {
    ...
    if (isFetching) return <div className="p-10 font-black uppercase animate-pulse">Retrieving Domain Data...</div>;
        ...
        <div className="space-y-6 max-w-4xl mx-auto pb-20 text-black">
            ...
            <div className="flex items-center justify-between border-b-4 border-black pb-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-black tracking-tighter uppercase italic leading-none">Modify / Domain Registry</h1>
                        <p className="text-[10px] font-black text-black uppercase tracking-[0.2em] mt-1">ID: {id?.slice(-8)} / Vector Update</p>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 text-black">
                ...
                {/* Visual Assets */}
                <div className="border-4 border-black bg-white shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] flex flex-col pt-0 text-black">
                    <div className="bg-gray-50 border-b-4 border-black p-4">
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        >
                            ...
                            {isLoading ? (
                                ...
                                <>
                                    <FolderSync className="w-8 h-8 mb-2 group-hover:scale-110 transition-transform" />
                                    <span className="text-[10px] font-black uppercase tracking-widest text-gray-500">Re-inject Asset Vector</span>
                                </>
                            )}
                        </div>
